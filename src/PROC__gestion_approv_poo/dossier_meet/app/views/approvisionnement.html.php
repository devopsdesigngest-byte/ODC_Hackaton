        ...
        <div class="main-layout">
            ...
            <div>
                ...
                <div class="panel-card" style="padding: 24px; border: 1px solid rgba(14, 165, 233, 0.2); background: linear-gradient(180deg, rgba(17, 24, 43, 0.5) 0%, rgba(10, 15, 30, 0.3) 100%);">
                    ...
                    <form id="supply-mock-form" action="http://localhost:8004/addAppro" method="POST">
                        
                        <div class="form-group">
                            <label for="supplier-select">Fournisseur Partenaire</label>
                            <div style="position: relative;">
                                <select id="supplier-select" class="form-control" name="fournisseur_id" style="width: 100%; appearance: none; padding-right: 30px;">
                        ...
                        <div style="border-top: 1px dashed var(--border-color); padding-top: 16px; margin-top: 16px; margin-bottom: 16px;">
                            ...
                            <div style="display: grid; grid-template-columns: 2fr 1fr auto; gap: 12px; align-items: flex-end; margin-bottom: 16px;">
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <select id="pos-item-select" class="form-control" name="article" style="background-color: #0b0f1a; color: white;">
                                         <?php foreach($produits as $produit): ?>
                                        <option value="<?= $produit["id"]."_".$produit["libelle"]."_".$produit["prix_achat"] ?>" data-name="Sac de riz 50kg"><?= $produit["libelle"] ?> (Coût d'achat : <?= $produit["prix_achat"] ?> F)</option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label for="pos-qty">Quantité Lot</label>
                                    <input type="number" id="pos-qty" name="quantite_appro" class="form-control" value="10" style="padding: 12px 10px;">
                                </div>
                                <button formaction="http://localhost:8004/addPanier" type="submit" class="btn-submit" style="height: 46px; width: 46px; font-size: 18px; display: flex; justify-content: center; align-items: center; background: linear-gradient(135deg, var(--accent) 0%, #0369a1 100%); font-weight: bold; border-radius: 10px;">+</button>
                            </div>
                            ...
                            <table class="debt-table" style="font-size: 12px;">
                                ...
                                <tbody id="cart-rows">
                                    ...
                                    <?php else  :  ?>
                                        <?php foreach($paniers["item"] as $panier) : ?>
                                        <tr>
                                            <td style="padding: 8px 0; font-weight:700;"><?= $panier["libelle"] ?></td>
                                            <td style="padding: 8px 0;"><?= $panier["quantite"] ?></td>
                                            <td style="padding: 8px 0; font-weight:800; color:var(--accent);"><?= $panier["montant"] ?></td>
                                            <td style="padding: 8px 0; text-align:right;">
                                                <button type="button" style="background:none; border:none; color:var(--danger); cursor:pointer; font-size:14px;">🗑️</button>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
                                    <?php endif ?>
                        ...
                        <div style="background: linear-gradient(135deg, rgba(14, 165, 233, 0.08) 0%, rgba(30, 41, 59, 0.4) 100%); border: 1px solid rgba(14, 165, 233, 0.15); border-radius: 16px; padding: 18px; text-align: center; margin-bottom: 20px; box-shadow: inset 0 0 15px rgba(14, 165, 233, 0.08);">
                            ...
                            <div style="font-size: 28px; font-weight: 900; color: #38bdf8; letter-spacing: -0.5px; font-family: monospace; text-shadow: 0 0 10px rgba(56, 189, 248, 0.3);">
                                <span id="montant_total_display_text"><?= $paniers["montant"] ?></span> <span style="font-size: 16px; font-weight: 700;">FCFA</span>
                            </div>
                        </div>

                        <div class="form-group" style="margin-bottom: 24px;">
                            <label for="reference-bordereau">Référence du Bordereau de Livraison (Fournisseur)</label>
                            <input type="text" id="reference_bordereau" name="ref_bordereau_livraison" class="form-control" placeholder="Ex: BL-CCS-2026-98">
                        </div>
            ...
            <div>
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <table class="debt-table" style="font-size: 12px;">
                        ...
                        <tbody>
                            <tr>
                                <td style="font-weight: 700;">#BL-CCS-098</td>
                                <td>CCS</td>
                                <td>4 200 000 F</td>
                                <td>4 200 000 F</td>
                                <td style="color: var(--success); font-weight: 700;">✓ CONCORDE</td>
                            </tr>
                            <tr id="ledger-row-2">
                                ...
                                <td style="color: var(--warning); font-weight: 700;">🕒 EN ATTENTE</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
