...
<body>
    ...
    <div id="login-screen"
        style="position: fixed; inset: 0; background: var(--bg-color); z-index: 9999; display: grid; grid-template-columns: 1.1fr 1fr; font-family: var(--font-family); color: var(--text-main);">

        <!-- Colonne Gauche : Branding & Visual Hero (Fond Sombre Deep Navy / Teal Accent) -->
        <div
            style="background: linear-gradient(135deg, #0b0f19 0%, #111827 50%, #0d1b2a 100%); border-right: 1px solid var(--border-color); padding: 48px; display: flex; flex-direction: column; justify-content: space-between; color: var(--text-main); position: relative; overflow: hidden;">
            <!-- Cercles décoratifs en arrière-plan avec l'accent Cyan/Teal -->
            <div
                style="position: absolute; width: 650px; height: 650px; border-radius: 50%; border: 1px solid rgba(45, 212, 191, 0.08); bottom: -200px; left: -100px; pointer-events: none;">
            </div>
            <div
                style="position: absolute; width: 450px; height: 450px; border-radius: 50%; border: 1px solid rgba(45, 212, 191, 0.12); bottom: -100px; left: 0px; pointer-events: none;">
            </div>
            <div
                style="position: absolute; width: 250px; height: 250px; border-radius: 50%; background: radial-gradient(circle, rgba(45, 212, 191, 0.15) 0%, transparent 70%); top: 20%; right: 10%; pointer-events: none;">
            </div>

            <!-- Header Brand Logo -->
            <div style="display: flex; align-items: center; gap: 12px; z-index: 2;">
                <div
                    style="background: rgba(22, 30, 49, 0.8); border: 1px solid var(--border-color); backdrop-filter: blur(12px); padding: 10px 20px; border-radius: 14px; display: flex; align-items: center; gap: 12px; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
                    <span style="font-size: 26px;">📦</span>
                    <div>
                        <div
                            style="font-weight: 800; color: var(--accent); font-size: 17px; line-height: 1.1; letter-spacing: -0.5px;">
                            StoreManager Pro</div>
                        <div
                            style="font-size: 9px; color: var(--text-muted); font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">
                            Gérez aujourd'hui, réussissez demain.</div>
                    </div>
                </div>
            </div>
            ...
            <div style="max-width: 520px; z-index: 2; margin: 60px 0;">
                <div
                    style="display: inline-block; background: var(--accent-glow); border: 1px solid var(--accent); border-radius: 20px; padding: 6px 14px; font-size: 11px; font-weight: 800; letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 24px; color: var(--accent);">
                    COMMERCE • SÉNÉGAL
                </div>
                <h1
                    style="font-size: 42px; font-weight: 800; line-height: 1.15; margin-bottom: 20px; color: #ffffff; letter-spacing: -1px;">
                    Une boutique mieux pilotée,<br>
                    <span style="color: var(--accent); text-shadow: 0 0 20px rgba(45, 212, 191, 0.3);">une rentabilité
                        optimisée.</span>
                </h1>
                <p
                    style="font-size: 15px; color: var(--text-muted); line-height: 1.6; margin-bottom: 32px; font-weight: 400;">
                    Ventes, stock, dettes clients et suivi fournisseurs réunis dans un espace clair, rapide et taillé
                    pour le commerce moderne.
                </p>

                <!-- Badge démo -->
                <div
                    style="background: rgba(22, 30, 49, 0.6); border: 1px solid var(--border-color); border-radius: 14px; padding: 14px 18px; display: flex; align-items: center; gap: 14px; width: fit-content;">
                    <div
                        style="width: 36px; height: 36px; background: var(--accent-glow); border: 1px solid var(--accent); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: var(--accent); font-size: 18px;">
                        🛡️</div>
                    <div>
                        <div style="font-size: 12px; font-weight: 700; color: #ffffff;">Espace de démonstration sécurisé
                        </div>
                        <div style="font-size: 11px; color: var(--text-muted);">Sélectionnez un profil pour tester
                            instantanément.</div>
                    </div>
                </div>
            </div>
        ...
        <div
            style="background: #0f1523; padding: 48px 64px; display: flex; flex-direction: column; justify-content: center; overflow-y: auto; color: var(--text-main);">
            <div style="max-width: 520px; width: 100%; margin: 0 auto;">

                <div
                    style="font-size: 11px; font-weight: 800; color: var(--accent); letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 6px;">
                    RAVI DE VOUS REVOIR
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 24px;">
                    <!-- Profil 1: Admin -->
                    <div onclick="selectQuickProfile('admin', 'admin@storemanager.sn', '👑 Admin Boutique')"
                        class="quick-profile-card active" id="profile-card-admin"
                        style="background: rgba(22, 30, 49, 0.7); border: 2px solid var(--accent); border-radius: 14px; padding: 14px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                        <div
                            style="width: 40px; height: 40px; background: rgba(45, 212, 191, 0.15); border: 1px solid var(--accent); border-radius: 10px; font-size: 12px; font-weight: 800; color: var(--accent); display: flex; align-items: center; justify-content: center;">
                            AB</div>
                        <div>
                    ...
                    <div onclick="selectQuickProfile('vente', 'vente@storemanager.sn', '🛒 Chargé de Vente')"
                        class="quick-profile-card" id="profile-card-vente"
                        style="background: rgba(22, 30, 49, 0.4); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 14px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s;">
                        <div
                            style="width: 40px; height: 40px; background: rgba(56, 189, 248, 0.15); border: 1px solid #38bdf8; border-radius: 10px; font-size: 12px; font-weight: 800; color: #38bdf8; display: flex; align-items: center; justify-content: center;">
                            CV</div>
                        <div>
                    ...
                    <div onclick="selectQuickProfile('stock', 'stock@storemanager.sn', '📦 Chargé de Stock')"
                        class="quick-profile-card" id="profile-card-stock"
                        style="background: rgba(22, 30, 49, 0.4); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 14px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s;">
                        <div
                            style="width: 40px; height: 40px; background: rgba(251, 191, 36, 0.15); border: 1px solid var(--warning); border-radius: 10px; font-size: 12px; font-weight: 800; color: var(--warning); display: flex; align-items: center; justify-content: center;">
                            CS</div>
                        <div>
                    ...
                    <!-- Profil 4: Inventaire -->
                    <div onclick="selectQuickProfile('inventaire', 'inventaire@storemanager.sn', '📋 Inventaire')"
                        class="quick-profile-card" id="profile-card-inventaire"
                        style="background: rgba(22, 30, 49, 0.4); border: 1px solid rgba(255,255,255,0.08); border-radius: 14px; padding: 14px; display: flex; align-items: center; gap: 12px; cursor: pointer; transition: all 0.2s;">
                        <div
                            style="width: 40px; height: 40px; background: rgba(192, 132, 252, 0.15); border: 1px solid #c084fc; border-radius: 10px; font-size: 12px; font-weight: 800; color: #c084fc; display: flex; align-items: center; justify-content: center;">
                            IV</div>
                        <div>
                ...
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
                    ...
                    <div style="font-size: 11px; color: var(--text-muted); font-weight: 500;">ou avec vos identifiants
                    </div>
                    <div style="flex: 1; height: 1px; background: rgba(255,255,255,0.08);"></div>
                </div>
                ...
                <form onsubmit="handleLogin(event)" style="display: flex; flex-direction: column; gap: 16px;">
                    ...
                    <div>
                        <label
                            style="font-size: 11px; font-weight: 700; color: var(--text-muted); display: block; margin-bottom: 6px; text-transform: uppercase;">Adresse
                            email</label>
                        <div style="position: relative;">
                            <span
                                style="position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--text-muted); font-size: 14px;">👤</span>
                            <input type="email" id="login-email" class="form-control" value="admin@storemanager.sn"
                                placeholder="vous@boutique.sn"
                                style="width: 100%; padding: 12px 14px 12px 40px; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: 10px; color: #ffffff; font-size: 13px;"
                                required>
                        </div>
                    </div>
                    ...
                    <div>
                        <div
                            ...
                            <label
                                style="font-size: 11px; font-weight: 700; color: var(--text-muted); text-transform: uppercase;">Mot
                                de passe</label>
                            <a href="#" onclick="alert('Mot de passe par défaut : demo1234'); return false;"
                                style="font-size: 11px; font-weight: 600; color: var(--accent); text-decoration: none;">Mot
                                de passe oublié ?</a>
                        </div>
                        <div style="position: relative;">
                            <span
                                style="position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--text-muted); font-size: 14px;">🔒</span>
                            <input type="password" id="login-password" class="form-control" value="demo1234"
                                placeholder="Votre mot de passe"
                                style="width: 100%; padding: 12px 40px 12px 40px; background: rgba(15, 23, 42, 0.6); border: 1px solid var(--border-color); border-radius: 10px; color: #ffffff; font-size: 13px;"
                                required>
                            <span
                                style="position: absolute; right: 14px; top: 50%; transform: translateY(-50%); color: var(--text-muted); font-size: 14px; cursor: pointer;">👁️</span>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px;">
                        ...
                        <label for="remember-me"
                            style="font-size: 12px; color: var(--text-muted); cursor: pointer;">Rester connecté sur cet
                            appareil</label>
                    </div>

                    <button type="submit" class="btn-submit"
                        style="padding: 14px; font-size: 14px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; display: flex; align-items: center; justify-content: center; gap: 8px; margin-top: 8px; box-shadow: 0 10px 25px rgba(45, 212, 191, 0.25);">
                        Se connecter ➔
                    </button>
                </form>

                <div style="text-align: center; margin-top: 18px; font-size: 11px; color: var(--text-muted);">
                    ✓ Tous les comptes utilisent le mot de passe : <strong
                        style="color: var(--accent);">demo1234</strong>
                </div>
        ...
        <div class="navbar">
            ...
            <div style="margin-left: auto; display: flex; align-items: center; gap: 14px;">
                <div style="text-align: right;">
                    <div id="current-user-role" style="font-size: 12px; font-weight: 800; color: var(--accent);">Admin
                        Boutique</div>
                    <div style="font-size: 10px; color: var(--text-muted);">Session active</div>
                </div>
                <button type="button" class="btn-quick-action" onclick="logout()"
                    style="border-color: var(--danger); color: var(--danger); background: rgba(248, 113, 113, 0.08); padding: 8px 12px;">Déconnexion
                    🚪</button>
            </div>
        </div>
        ...
        <div id="view-dashboard" class="view-section">
            <div class="kpi-grid">
                ...
                <div class="kpi-card" style="border-left: 4px solid var(--success);">
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            ...
                            <circle class="progress-ring-circle" style="stroke: var(--success); stroke-dashoffset: 20;"
                                cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="kpi-card" style="border-left: 4px solid var(--danger);">
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            <circle class="progress-ring-circle-bg" cx="30" cy="30" r="25" />
                            <circle class="progress-ring-circle" style="stroke: var(--danger); stroke-dashoffset: 70;"
                                cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="kpi-card" style="border-left: 4px solid var(--accent);">
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            <circle class="progress-ring-circle-bg" cx="30" cy="30" r="25" />
                            <circle class="progress-ring-circle" style="stroke: var(--accent); stroke-dashoffset: 40;"
                                cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
                ...
                <div class="kpi-card" style="border-left: 4px solid var(--warning);">
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            <circle class="progress-ring-circle-bg" cx="30" cy="30" r="25" />
                            <circle class="progress-ring-circle" style="stroke: var(--warning); stroke-dashoffset: 15;"
                                cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            ...
                            <circle class="progress-ring-circle"
                                style="stroke: var(--success); stroke-dashoffset: 116.808;" cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
                <!-- Radial Chart 6 -->
                <div class="kpi-card" style="border-left: 4px solid var(--accent);">
                    ...
                    <div class="progress-ring-container">
                        <svg class="progress-ring" width="60" height="60">
                            <circle class="progress-ring-circle-bg" cx="30" cy="30" r="25" />
                            <circle class="progress-ring-circle" style="stroke: var(--accent); stroke-dashoffset: 50;"
                                cx="30" cy="30" r="25" />
                        </svg>
                    </div>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 32px; align-items: start;">
                ...
                <div class="panel-card" style="padding: 20px;">
                    <div
                        style="display: flex; gap: 8px; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 12px;">
                        <button id="dash-left-tab-sales" class="nav-item active"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashLeftTab('sales')">🛒 Ventes Récentes</button>
                        <button id="dash-left-tab-debts" class="nav-item"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashLeftTab('debts')">🔴 Dettes du Jour</button>
                        <button id="dash-left-tab-ruptures" class="nav-item"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashLeftTab('ruptures')">⚠️ Ruptures & Alertes</button>
                    </div>
                    ...
                    <div id="dash-left-panel-debts" style="display: none;">
                        <div class="panel-title" style="border-left-color: var(--danger);">Dettes à recouvrer
                            aujourd'hui</div>
                        <table class="debt-table" style="font-size: 12px;">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="5"
                                        style="text-align: center; color: var(--text-muted); padding: 16px 0;">Aucun
                                        crédit en cours créé aujourd'hui.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div id="dash-left-panel-ruptures" style="display: none;">
                        <div class="panel-title" style="border-left-color: var(--danger);">Ruptures & Stocks Critiques
                        </div>
                        <div style="display: flex; flex-direction: column; gap: 14px;">
                            <div
                                style="background: rgba(251,191,36,0.05); padding: 12px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.02);">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        <div style="font-weight: 700; font-size: 13px;">Bidon d&#039;huile 5L</div>
                                        <div style="color: var(--warning); font-weight: 800; font-size: 11px;">5 en
                                            stock</div>
                                    </div>
                                    <button type="button" class="btn-quick-action"
                                        onclick="toggleDetails('supply-product-drawer-2')"
                                        style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Approvisionner</button>
                                </div>

                                <!-- Inline drawer for quick supply request -->
                                <div class="details-drawer" id="supply-product-drawer-2"
                                    style="margin-top: 10px; padding: 10px;">
                                    <div
                                        style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                        Commande d'Approvisionnement Rapide :</div>
                                    <form method="GET" action="#"
                                        onsubmit="event.preventDefault(); alert('Action enregistrée (mode démonstration HTML/CSS)');"
                                        action=""
                                        style="display: grid; grid-template-columns: 1.5fr 1fr 1fr auto; gap: 8px; align-items: flex-end;">
                                        <input type="hidden" name="action" value="quick_supply_product">
                                        <input type="hidden" name="produit_id" value="2">

                                        <div>
                                            <label
                                                style="font-size: 9px; color: var(--text-muted); display: block; margin-bottom: 2px;">Fournisseur</label>
                                            <select name="fournisseur_id" class="form-control"
                                                style="font-size: 11px; padding: 6px;" required>
                                        ...
                                        <div>
                                            <label
                                                style="font-size: 9px; color: var(--text-muted); display: block; margin-bottom: 2px;">Qté
                                                à Commander</label>
                                            <input type="number" name="quantite" class="form-control" value="50" min="1"
                                                required style="font-size: 11px; padding: 6px;">
                                        </div>
                                        <div>
                                            <label
                                                style="font-size: 9px; color: var(--text-muted); display: block; margin-bottom: 2px;">Coût
                                                Achat (F)</label>
                                            <input type="number" name="cout_achat_unitaire" class="form-control"
                                                value="5600" min="0" required style="font-size: 11px; padding: 6px;">
                                        </div>
                                        <button type="submit" class="btn-submit btn-success"
                                            style="padding: 6px 12px; font-size: 10px; text-transform: uppercase;">Valider
                                            BL</button>
                                    </form>
                                </div>
                            </div>
                            <div
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        ...
                                        <div style="color: var(--warning); font-weight: 800; font-size: 11px;">3 en
                                            stock</div>
                                    </div>
                                    <button type="button" class="btn-quick-action"
                                        onclick="toggleDetails('supply-product-drawer-3')"
                                        style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Approvisionner</button>
                                </div>

                                <!-- Inline drawer for quick supply request -->
                                <div class="details-drawer" id="supply-product-drawer-3"
                                    style="margin-top: 10px; padding: 10px;">
                                    <div
                                        style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                        Commande d'Approvisionnement Rapide :</div>
                                    <form method="GET" action="#"
                                        ...
                                        <div>
                                            <label
                                                ...
                                                Achat (F)</label>
                                            <input type="number" name="cout_achat_unitaire" class="form-control"
                                                value="8400" min="0" required style="font-size: 11px; padding: 6px;">
                                        </div>
                                        <button type="submit" class="btn-submit btn-success"
                                            style="padding: 6px 12px; font-size: 10px; text-transform: uppercase;">Valider
                                            BL</button>
                            ...
                            <div
                                style="background: rgba(248,113,113,0.05); padding: 12px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.02);">
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    <div>
                                        <div style="font-weight: 700; font-size: 13px;">Huile de palme 1L</div>
                                        <div style="color: var(--danger); font-weight: 800; font-size: 11px;">0 en stock
                                        </div>
                                    </div>
                                    <button type="button" class="btn-quick-action"
                                        onclick="toggleDetails('supply-product-drawer-6')"
                                        style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Approvisionner</button>
                                </div>

                                <!-- Inline drawer for quick supply request -->
                                <div class="details-drawer" id="supply-product-drawer-6"
                                    style="margin-top: 10px; padding: 10px;">
                                    <div
                                        style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                        Commande d'Approvisionnement Rapide :</div>
                                    <form method="GET" action="#"
                                        ...
                                        <div>
                                            <label
                                                ...
                                                Achat (F)</label>
                                            <input type="number" name="cout_achat_unitaire" class="form-control"
                                                value="1400" min="0" required style="font-size: 11px; padding: 6px;">
                                        </div>
                                        <button type="submit" class="btn-submit btn-success"
                                            style="padding: 6px 12px; font-size: 10px; text-transform: uppercase;">Valider
                                            BL</button>
                ...
                <div class="panel-card" style="padding: 20px;">
                    <div
                        style="display: flex; gap: 8px; margin-bottom: 20px; border-bottom: 1px solid var(--border-color); padding-bottom: 12px;">
                        <button id="dash-right-tab-supplies" class="nav-item active"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashRightTab('supplies')">📦 Livraisons du Jour</button>
                        <button id="dash-right-tab-debtors" class="nav-item"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashRightTab('debtors')">👥 Clients Débiteurs</button>
                        <button id="dash-right-tab-fournisseurs" class="nav-item"
                            style="flex: 1; padding: 10px; font-size: 11px; text-transform: uppercase;"
                            onclick="switchDashRightTab('fournisseurs')">🤝 Solde Fournisseurs</button>
                    </div>

                    <!-- Tab 1: Approvisionnements attendus aujourd'hui -->
                    <div id="dash-right-panel-supplies">
                        <div class="panel-title" style="border-left-color: var(--warning);">Approvisionnements attendus
                            aujourd'hui</div>
                        <table class="debt-table" style="font-size: 12px;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="4"
                                        style="text-align: center; color: var(--text-muted); padding: 16px 0;">Aucune
                                        livraison attendue aujourd'hui.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div id="dash-right-panel-debtors" style="display: none;">
                        <div class="panel-title" style="border-left-color: var(--danger);">Clients avec Dettes en cours
                        </div>
                        <table class="debt-table" style="font-size: 12px;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-weight: 700;">
                                        Moussa Sarr <div
                                            style="font-size: 10px; color: var(--text-muted); font-weight: normal;">
                                            769876543</div>
                                    </td>
                                    ...
                                    <td>
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('client-debts-drawer-3')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Dettes</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="client-debts-drawer-3">
                                            <div
                                                style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                                Dettes en cours de Moussa Sarr :</div>
                                            <table class="debt-table" style="font-size: 10px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="font-weight: 700; color: var(--text-muted);">#DT-2
                                                        </td>
                                                        <td>07 Aug 22:48</td>
                                                        <td style="font-weight: 700;">74 000 F</td>
                                                        <td style="color: var(--success);">24 000 F</td>
                                                        <td style="color: var(--danger); font-weight: 800;">50 000 F
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn-quick-action"
                                                                onclick="switchView('dettes'); toggleDetails('debt-repay-drawer-2')"
                                                                style="border-color: var(--danger); color: var(--danger);">Rembourser</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('client-debts-drawer-2')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Dettes</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="client-debts-drawer-2">
                                            <div
                                                style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                                Dettes en cours de Fama Diouf :</div>
                                            <table class="debt-table" style="font-size: 10px;">
                                                <thead>
                                                    <tr>
                                                        <th>Réf Dette</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="font-weight: 700; color: var(--text-muted);">#DT-1
                                                        </td>
                                                        <td>07 Aug 21:48</td>
                                                        <td style="font-weight: 700;">44 000 F</td>
                                                        <td style="color: var(--success);">10 000 F</td>
                                                        <td style="color: var(--danger); font-weight: 800;">34 000 F
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn-quick-action"
                                                                onclick="switchView('dettes'); toggleDetails('debt-repay-drawer-1')"
                                                                style="border-color: var(--danger); color: var(--danger);">Rembourser</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('client-debts-drawer-4')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Dettes</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="client-debts-drawer-4">
                                            <div
                                                style="font-weight: 700; font-size: 11px; color: var(--accent); margin-bottom: 6px;">
                                                Dettes en cours de Maimouna Diallo :</div>
                                            <table class="debt-table" style="font-size: 10px;">
                                                <thead>
                                                    <tr>
                                                        <th>Réf Dette</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="font-weight: 700; color: var(--text-muted);">#DT-3
                                                        </td>
                                                        <td>07 Aug 23:48</td>
                                                        <td style="font-weight: 700;">15 000 F</td>
                                                        <td style="color: var(--success);">0 F</td>
                                                        <td style="color: var(--danger); font-weight: 800;">15 000 F
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn-quick-action"
                                                                onclick="switchView('dettes'); toggleDetails('debt-repay-drawer-3')"
                                                                style="border-color: var(--danger); color: var(--danger);">Rembourser</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                    ...
                    <div id="dash-right-panel-fournisseurs" style="display: none;">
                        <div class="panel-title" style="border-left-color: var(--accent);">Facturation / Cumul par
                            Fournisseur</div>
                        <table class="debt-table" style="font-size: 12px;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="font-weight: 700;">
                                        Comptoir Céréalier Sénégalais <div
                                            style="font-size: 10px; color: var(--text-muted); font-weight: normal;">Tél
                                            : 338245678</div>
                                    </td>
                                    <td style="font-weight: 800; color: var(--accent);">525 000 F</td>
                                    <td style="display: flex; gap: 6px; align-items: center;">
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('supplier-invoices-drawer-1')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Détail</button>

                                        <form method="GET" action="#"
                                            onsubmit="event.preventDefault(); alert('Action enregistrée (mode démonstration HTML/CSS)');"
                                            action="" style="display: inline; margin: 0;">
                                            ...
                                            <button type="submit" class="btn-quick-action"
                                                style="border-color: var(--success); color: var(--success); background: rgba(52, 211, 153, 0.05);">Tout
                                                Payer</button>
                                        </form>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="supplier-invoices-drawer-1"
                                            style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 12px; padding: 14px 16px; margin: 8px 0;">
                                            <div
                                                style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; border-bottom: 1px dashed var(--border-color); padding-bottom: 8px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="5"
                                                            ...
                                                            Aucune facture impayée pour ce fournisseur.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td style="display: flex; gap: 6px; align-items: center;">
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('supplier-invoices-drawer-2')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Détail</button>
                                ...
                                <tr>
                                    <td colspan="3" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="supplier-invoices-drawer-2"
                                            style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 12px; padding: 14px 16px; margin: 8px 0;">
                                            <div
                                                style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; border-bottom: 1px dashed var(--border-color); padding-bottom: 8px;">
                                                <div style="font-weight: 800; font-size: 11px; color: var(--accent);">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="font-weight: 700; color: var(--text-muted);">
                                                            #BL-DIP-099</td>
                                                        <td>03 Aug 2026</td>
                                                        <td style="font-weight: 800; color: var(--accent);">320 000 F
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <form method="GET" action="#"
                                                                ...
                                                                <input type="hidden" name="action"
                                                                    value="pay_supplier_invoice">
                                                                <input type="hidden" name="approvisionnement_id"
                                                                    value="2">
                                                                <button type="submit" class="btn-quick-action"
                                                                    style="border-color: var(--success); color: var(--success); background: rgba(52, 211, 153, 0.08); font-weight: 700;">✓
                                                                    Payer</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="display: flex; gap: 6px; align-items: center;">
                                        <button type="button" class="btn-quick-action"
                                            onclick="toggleDetails('supplier-invoices-drawer-3')"
                                            style="border-color: var(--accent); color: var(--accent); background: rgba(45, 212, 191, 0.05);">Détail</button>
                                ...
                                <tr>
                                    <td colspan="3" style="padding: 0; border: none;">
                                        <div class="details-drawer" id="supplier-invoices-drawer-3"
                                            style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 12px; padding: 14px 16px; margin: 8px 0;">
                                            <div
                                                style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; border-bottom: 1px dashed var(--border-color); padding-bottom: 8px;">
                                                <div style="font-weight: 800; font-size: 11px; color: var(--accent);">
            ...
            <div
                ...
                <div class="panel-card"
                    ...
                    <form method="GET" action="#"
                        ...
                        <div class="form-group">
                            ...
                            <div style="position: relative;">
                                <select name="client_id" id="client-select" class="form-control"
                                    style="width: 100%; appearance: none; padding-right: 30px;"
                                    onchange="updateClientLimitInfo()">
                                ...
                                <span
                                    style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); pointer-events: none; color: var(--text-muted); font-size: 12px;">▼</span>
                            </div>
                            <span id="credit-limit-info"
                                style="font-size:11px; color:var(--text-muted); font-weight:600; margin-top:4px; display:block;"></span>
                        </div>

                        <!-- Articles Dynamic add -->
                        <div
                            style="border-top: 1px dashed var(--border-color); padding-top: 16px; margin-top: 16px; margin-bottom: 16px;">
                            <label
                                style="font-size: 12px; font-weight: 700; color: var(--accent); display: block; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.5px;">Sélection
                                des Articles</label>
                            <div
                                style="display: grid; grid-template-columns: 2.2fr 0.8fr auto; gap: 8px; align-items: flex-end; margin-bottom: 16px;">
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label for="pos-item-select" style="font-size: 10px;">Article</label>
                                    <select id="pos-item-select" class="form-control"
                                        style="background-color: #0b0f1a; color: white; padding: 10px; font-size: 12px;">
                                        <option value="2" data-price="8000" data-name="Bidon d&#039;huile 5L"
                                            data-stock="5">
                                        ...
                                        <option value="6" data-price="2000" data-name="Huile de palme 1L"
                                            data-stock="0">
                                            🔴 Huile de palme 1L (0) </option>
                                        <option value="4" data-price="1500" data-name="Paquet de sucre 1kg"
                                            data-stock="200">
                                            🟢 Paquet de sucre 1kg (200) </option>
                                        <option value="1" data-price="25000" data-name="Sac de riz 50kg"
                                            data-stock="100">
                                ...
                                <div class="form-group" style="margin-bottom: 0; position: relative;">
                                    ...
                                    <input type="number" id="pos-qty" class="form-control" value="1" min="1"
                                        style="padding: 10px; font-size: 12px;" onfocus="showKeypad('pos-qty')">
                                </div>
                                <button type="button" class="btn-submit" onclick="addToCart(event)"
                                    style="height: 38px; width: 38px; font-size: 18px; display: flex; justify-content: center; align-items: center; border-radius: 8px; padding: 0; flex-shrink: 0; min-width: 38px;">+</button>
                            </div>
                            ...
                            <div class="keypad-container" id="pos-keypad" style="max-width: 100%;">
                                ...
                                <button type="button" class="keypad-btn" onclick="pressKey('C')"
                                    style="color: var(--danger);">C</button>
                                <button type="button" class="keypad-btn" onclick="pressKey(0)">0</button>
                                <button type="button" class="keypad-btn" onclick="hideKeypad()"
                                    style="color: var(--success); font-size: 12px;">OK</button>
                            </div>
                                ...
                                <tbody id="cart-rows">
                                    <tr id="empty-cart-row">
                                        <td colspan="4"
                                            ...
                                            Panier vide. Ajoutez des articles.</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div
                            style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(30, 41, 59, 0.4) 100%); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 16px; padding: 14px; text-align: center; margin-bottom: 20px; box-shadow: inset 0 0 15px rgba(59, 130, 246, 0.08);">
                            <span
                                style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700; letter-spacing: 1px; display: block; margin-bottom: 4px;">Montant
                                Total Net à Payer</span>
                            <div
                                style="font-size: 24px; font-weight: 900; color: #60a5fa; letter-spacing: -0.5px; font-family: monospace; text-shadow: 0 0 10px rgba(96, 165, 250, 0.3);">
                                <span id="montant_total_display_text">0</span> <span
                                    style="font-size: 14px; font-weight: 700;">FCFA</span>
                            </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 24px;">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <input type="number" name="montant_verse" id="pos-montant-verse" class="form-control"
                                    value="0" min="0" style="padding: 10px; font-size: 12px;"
                                    onfocus="showKeypad('pos-montant-verse')">
                            </div>
                        </div>

                        <button type="submit" class="btn-submit btn-success"
                            style="padding: 14px; font-weight: 800; font-size: 13px; width: 100%;">Valider la Vente
                            (DML)</button>
                    </form>
                </div>
                    ...
                    <table class="debt-table" id="orders-main-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="font-weight: 700;">
                                    Maimouna Diallo <div
                                        style="font-size:11px; color:var(--text-muted); font-weight:normal;">Tél :
                                        701122334</div>
                                </td>
                                <td style="font-weight: 800; color: var(--accent);">15 000 F</td>
                                <td>
        ...
        <div id="view-dettes" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 24px;">
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Créances
                            Actives</span>
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;">99 000 F</div>
                    </div>
                    <span style="font-size: 24px;">💸</span>
                ...
                <div class="panel-card"
                    style="padding: 16px; display: flex; align-items: center; justify-content: space-between; border-left: 4px solid var(--warning);">
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Clients
                            Débiteurs</span>
                ...
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Total
                            Recouvrements</span>
            ...
            <div style="display: block;">
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    <div class="panel-title">
                        ...
                        <input type="text" id="debt-search" class="search-control" placeholder="Rechercher un client..."
                    ...
                    <table class="debt-table" id="debts-main-table">
                        ...
                        <tbody>
                            <tr id="debt-row-3" data-client-name="maimouna diallo 701122334"
                                style="transition: all 0.2s;">
                                <td style="font-weight: 700; color: var(--text-muted);">
                                    #DT-3 <span
                                        style="font-size: 10px; color: var(--text-muted); display: block; font-weight: normal; margin-top: 2px;">#CMD-4</span>
                                </td>
                                ...
                                <td style="display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('debt-lines-3')">Articles</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--accent); color: var(--accent);"
                                        onclick="toggleDetails('debt-details-3')">💳 Paiements</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--warning); color: var(--warning);"
                                        onclick="toggleDetails('debt-repay-drawer-3')">Rembourser</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8" style="padding: 0; border: none;">
                                    ...
                                    <div class="details-drawer" id="debt-details-3">
                                        ...
                                        <table class="debt-table" style="font-size: 11px;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="3"
                                                        style="text-align: center; color: var(--text-muted);">Aucun
                                                        acompte versé.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="details-drawer" id="debt-lines-3">
                                        <div
                                            style="font-weight: 700; font-size: 12px; color: var(--accent); margin-bottom: 8px;">
                                            Articles de la Vente à Crédit :</div>
                                        <table class="debt-table" style="font-size: 11px;">
                                            <thead>
                                                <tr>
                                                    <th>Produit</th>
                                    ...
                                    <div class="details-drawer" id="debt-repay-drawer-3"
                                        style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 14px; padding: 18px 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); max-width: 850px; margin: 12px 0;">

                                        <!-- Header row with title and badge -->
                                        <div
                                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 14px; border-bottom: 1px dashed var(--border-color); padding-bottom: 10px;">
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                <span style="font-size: 16px;">💳</span>
                                                <span
                                                    style="font-weight: 800; font-size: 13px; color: var(--text-main);">
                                                    Nouveau Remboursement — <span style="color: var(--accent);">Maimouna
                                                        Diallo</span>
                                                </span>
                                            </div>
                                            <div
                                                style="background: rgba(244, 63, 94, 0.12); border: 1px solid rgba(244, 63, 94, 0.3); padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 800; color: var(--danger);">
                                        ...
                                        <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 16px;">
                                            <span
                                                style="font-size: 10px; text-transform: uppercase; color: var(--text-muted); font-weight: 700;">Raccourcis
                                                :</span>
                                            <button type="button" onclick="setRepayAmount(3, 15000)"
                                                style="background: rgba(45, 212, 191, 0.1); border: 1px solid var(--accent); color: var(--accent); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">Tout
                                                solder (15 000 F)</button>
                                            <button type="button" onclick="setRepayAmount(3, 7500)"
                                                style="background: rgba(255, 255, 255, 0.04); border: 1px solid var(--border-color); color: var(--text-main); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">50%
                                                (7 500 F)</button>
                                        </div>
                                        ...
                                        <form method="GET" action="#"
                                            ...
                                            <div style="flex: 1; min-width: 200px;">
                                                <label
                                                    style="font-size: 10px; color: var(--text-muted); display: block; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 700;">Montant
                                                    du Versement (FCFA)</label>
                                                <div style="position: relative;">
                                                    <input type="number" name="montant_verse" id="repay-input-3"
                                                        class="form-control" max="15000" value="15000" min="1" required
                                            ...
                                            <div style="flex: 1; min-width: 200px;">
                                                <label
                                                    style="font-size: 10px; color: var(--text-muted); display: block; margin-bottom: 6px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 700;">Canal
                                                    de Paiement</label>
                                                <select name="mode_paiement" class="form-control"
                                                    style="font-size: 13px; font-weight: 600; padding: 10px 12px; background: #0b0f19; border: 1px solid var(--border-color); color: white; width: 100%;"
                                                    required>
                                            ...
                                            <div>
                                                <button type="submit" class="btn-submit btn-success"
                                                    style="padding: 11px 24px; font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; display: flex; align-items: center; gap: 8px; border-radius: 10px; height: 42px;">
                            ...
                            <tr id="debt-row-2" data-client-name="moussa sarr 769876543" style="transition: all 0.2s;">
                                <td style="font-weight: 700; color: var(--text-muted);">
                                    #DT-2 <span
                                        style="font-size: 10px; color: var(--text-muted); display: block; font-weight: normal; margin-top: 2px;">#CMD-3</span>
                                </td>
                                ...
                                <td style="display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('debt-lines-2')">Articles</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--accent); color: var(--accent);"
                                        onclick="toggleDetails('debt-details-2')">💳 Paiements</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--warning); color: var(--warning);"
                                        onclick="toggleDetails('debt-repay-drawer-2')">Rembourser</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8" style="padding: 0; border: none;">
                                    ...
                                    <!-- Drawer 3: Remboursement form -->
                                    <div class="details-drawer" id="debt-repay-drawer-2"
                                        style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 14px; padding: 18px 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); max-width: 850px; margin: 12px 0;">
                                        ...
                                        <div
                                            ...
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                ...
                                                <span
                                                    style="font-weight: 800; font-size: 13px; color: var(--text-main);">
                                                    Nouveau Remboursement — <span style="color: var(--accent);">Moussa
                                                        Sarr</span>
                                                </span>
                                            </div>
                                            <div
                                        ...
                                        <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 16px;">
                                            <span
                                                style="font-size: 10px; text-transform: uppercase; color: var(--text-muted); font-weight: 700;">Raccourcis
                                                :</span>
                                            <button type="button" onclick="setRepayAmount(2, 50000)"
                                                style="background: rgba(45, 212, 191, 0.1); border: 1px solid var(--accent); color: var(--accent); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">Tout
                                                solder (50 000 F)</button>
                                            <button type="button" onclick="setRepayAmount(2, 25000)"
                                                style="background: rgba(255, 255, 255, 0.04); border: 1px solid var(--border-color); color: var(--text-main); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">50%
                                                (25 000 F)</button>
                                        </div>
                                        ...
                                        <form method="GET" action="#"
                                            ...
                                            <div style="flex: 1; min-width: 200px;">
                                                <label
                                                    ...
                                                    du Versement (FCFA)</label>
                                                <div style="position: relative;">
                                                    <input type="number" name="montant_verse" id="repay-input-2"
                                                        class="form-control" max="50000" value="50000" min="1" required
                                                        style="font-size: 13px; font-weight: 700; padding: 10px 12px; background: #0b0f19; border: 1px solid var(--border-color); color: white; width: 100%;">
                                                </div>
                                            </div>
                            ...
                            <tr id="debt-row-1" data-client-name="fama diouf 781234567" style="transition: all 0.2s;">
                                <td style="font-weight: 700; color: var(--text-muted);">
                                    #DT-1 <span
                                        style="font-size: 10px; color: var(--text-muted); display: block; font-weight: normal; margin-top: 2px;">#CMD-2</span>
                                </td>
                                ...
                                <td style="display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('debt-lines-1')">Articles</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--accent); color: var(--accent);"
                                        onclick="toggleDetails('debt-details-1')">💳 Paiements</button>
                                    <button class="btn-quick-action"
                                        style="border-color: var(--warning); color: var(--warning);"
                                        onclick="toggleDetails('debt-repay-drawer-1')">Rembourser</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8" style="padding: 0; border: none;">
                                    ...
                                    <!-- Drawer 3: Remboursement form -->
                                    <div class="details-drawer" id="debt-repay-drawer-1"
                                        style="border: 1px solid rgba(45, 212, 191, 0.25); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 14px; padding: 18px 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); max-width: 850px; margin: 12px 0;">
                                        ...
                                        <div
                                            ...
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                ...
                                                <span
                                                    style="font-weight: 800; font-size: 13px; color: var(--text-main);">
                                                    Nouveau Remboursement — <span style="color: var(--accent);">Fama
                                                        Diouf</span>
                                                </span>
                                            </div>
                                            <div
                                        ...
                                        <div style="display: flex; gap: 8px; align-items: center; margin-bottom: 16px;">
                                            <span
                                                style="font-size: 10px; text-transform: uppercase; color: var(--text-muted); font-weight: 700;">Raccourcis
                                                :</span>
                                            <button type="button" onclick="setRepayAmount(1, 34000)"
                                                style="background: rgba(45, 212, 191, 0.1); border: 1px solid var(--accent); color: var(--accent); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">Tout
                                                solder (34 000 F)</button>
                                            <button type="button" onclick="setRepayAmount(1, 17000)"
                                                style="background: rgba(255, 255, 255, 0.04); border: 1px solid var(--border-color); color: var(--text-main); font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 6px; cursor: pointer;">50%
                                                (17 000 F)</button>
                                        </div>
                                        ...
                                        <form method="GET" action="#"
                                            ...
                                            <div style="flex: 1; min-width: 200px;">
                                                <label
                                                    ...
                                                    du Versement (FCFA)</label>
                                                <div style="position: relative;">
                                                    <input type="number" name="montant_verse" id="repay-input-1"
                                                        class="form-control" max="34000" value="34000" min="1" required
                                                        style="font-size: 13px; font-weight: 700; padding: 10px 12px; background: #0b0f19; border: 1px solid var(--border-color); color: white; width: 100%;">
                                                </div>
                                            </div>
        ...
        <div id="view-supplies" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 24px;">
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Coût
                ...
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Bons
                            de Réception (BL)</span>
                ...
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Fournisseurs
                            Actifs</span>
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;">3 entreprises
                        </div>
                    </div>
                    <span style="font-size: 24px;">🤝</span>
                </div>
            ...
            <div style="display: block;">
                ...
                <div class="panel-card" style="padding: 20px; margin-bottom: 0;">
                    <div class="panel-title" style="font-size: 15px; margin-bottom: 16px;">Bordereaux de Livraison
                        (Réceptions)</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding: 8px 0;">
                                    Sénégal Import-Export <div style="font-size:10px; color:var(--text-muted);">Tél :
                                        338211010</div>
                                </td>
                                ...
                                <td style="padding: 8px 0; display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('supply-details-4')">Lignes</button>
                                    <button type="button" class="btn-quick-action"
                                        style="border-color: var(--success); color: var(--success); background: rgba(52, 211, 153, 0.05);"
                                        onclick="toggleDetails('supply-receive-drawer-4')">Réceptionner</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" style="padding: 0; border: none;">
                                    ...
                                    <div class="details-drawer" id="supply-receive-drawer-4"
                                        style="border: 1px solid rgba(52, 211, 153, 0.3); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 14px; padding: 18px 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); max-width: 850px; margin: 12px 0;">
                                        ...
                                        <div
                                            ...
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                ...
                                                <span
                                                    style="font-weight: 800; font-size: 13px; color: var(--text-main);">
                                                    Réceptionner le BL — <span
                                                        style="color: var(--accent);">BL-SEN-102</span>
                                                </span>
                                            </div>
                                            <div
                                                style="background: rgba(245, 158, 11, 0.12); border: 1px solid rgba(245, 158, 11, 0.3); padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 800; color: var(--warning);">
                                        ...
                                        <form method="GET" action="#"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    style="background: rgba(255,255,255,0.02); border: 1px solid var(--border-color); border-radius: 10px; padding: 10px 14px; display: flex; justify-content: space-between; align-items: center;">
                                                    <div>
                                                        <div style="font-weight: 700; font-size: 13px; color: white;">
                                                            Paquet de sucre 1kg</div>
                                                        <div
                                                            style="font-size: 11px; color: var(--text-muted); margin-top: 2px;">
                                                            Quantité théorique commandée : <strong
                                                                style="color: var(--text-main);">50</strong>
                                                        </div>
                                                    </div>
                                                    <div style="display: flex; align-items: center; gap: 10px;">
                                                        <label
                                                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Qté
                                                            Reçue :</label>
                                                        <input type="number" name="quantites_livrees[4]"
                                                            class="form-control" value="50" min="0" required
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <div
                                                            style="font-size: 11px; color: var(--text-muted); margin-top: 2px;">
                                                            Quantité théorique commandée : <strong
                                                                style="color: var(--text-main);">10</strong>
                                                        </div>
                                                    </div>
                                                    <div style="display: flex; align-items: center; gap: 10px;">
                                                        <label
                                                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Qté
                                                            Reçue :</label>
                                                        <input type="number" name="quantites_livrees[5]"
                                                            class="form-control" value="10" min="0" required
                                                            style="width: 100px; padding: 6px 10px; font-size: 13px; font-weight: 700; text-align: center; background: #0b0f1a;">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div style="display: flex; justify-content: flex-end;">
                                                <button type="submit" class="btn-submit btn-success"
                                                    style="padding: 11px 24px; font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; display: flex; align-items: center; gap: 8px; border-radius: 10px;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px 0;">
                                    Comptoir Céréalier Sénégalais <div style="font-size:10px; color:var(--text-muted);">
                                        Tél : 338245678</div>
                                </td>
                                ...
                                <td style="padding: 8px 0; display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('supply-details-3')">Lignes</button>
                                    <button type="button" class="btn-quick-action"
                                        style="border-color: var(--success); color: var(--success); background: rgba(52, 211, 153, 0.05);"
                                        onclick="toggleDetails('supply-receive-drawer-3')">Réceptionner</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" style="padding: 0; border: none;">
                                    ...
                                    <!-- Drawer 2: Confirm Reception Form inline -->
                                    <div class="details-drawer" id="supply-receive-drawer-3"
                                        style="border: 1px solid rgba(52, 211, 153, 0.3); background: linear-gradient(180deg, rgba(11, 15, 25, 0.95) 0%, rgba(11, 15, 25, 0.98) 100%); border-radius: 14px; padding: 18px 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.4); max-width: 850px; margin: 12px 0;">
                                        ...
                                        <div
                                            ...
                                            <div style="display: flex; align-items: center; gap: 8px;">
                                                ...
                                                <span
                                                    style="font-weight: 800; font-size: 13px; color: var(--text-main);">
                                                    Réceptionner le BL — <span
                                                        style="color: var(--accent);">BL-CCS-101</span>
                                                </span>
                                            </div>
                                            <div
                                                style="background: rgba(245, 158, 11, 0.12); border: 1px solid rgba(245, 158, 11, 0.3); padding: 4px 12px; border-radius: 20px; font-size: 11px; font-weight: 800; color: var(--warning);">
                                                ...
                                                <div
                                                    ...
                                                    <div>
                                                        ...
                                                        <div
                                                            style="font-size: 11px; color: var(--text-muted); margin-top: 2px;">
                                                            Quantité théorique commandée : <strong
                                                                style="color: var(--text-main);">25</strong>
                                                        </div>
                                                    </div>
                                                    <div style="display: flex; align-items: center; gap: 10px;">
                                                        <label
                                                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Qté
                                                            Reçue :</label>
                                                        <input type="number" name="quantites_livrees[1]"
                                                            class="form-control" value="25" min="0" required
                                                            style="width: 100px; padding: 6px 10px; font-size: 13px; font-weight: 700; text-align: center; background: #0b0f1a;">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px 0;">
                                    Grossiste Diop &amp; Frères <div style="font-size:10px; color:var(--text-muted);">
                                        Tél : 773456789</div>
                                </td>
                                ...
                                <td style="padding: 8px 0; display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('supply-details-2')">Lignes</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" style="padding: 0; border: none;">
                            ...
                            <tr>
                                ...
                                <td style="padding: 8px 0; display: flex; gap: 6px;">
                                    <button class="btn-quick-action"
                                        onclick="toggleDetails('supply-details-1')">Lignes</button>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="5" style="padding: 0; border: none;">
        ...
        <div id="view-catalog" class="view-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-bottom: 24px;">
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Valeur
                            Totale Stock</span>
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;"><?= $VST ?> F
                        </div>
                    </div>
                    <span style="font-size: 24px;">📦</span>
                </div>
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            style="font-size: 10px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Articles
                            au Catalogue</span>
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;">
                            <?php echo $nbrProd ?> références
                        </div>
                    </div>
                ...
                <div class="panel-card"
                    ...
                    <div>
                        <span
                            ...
                            Enregistrés</span>
                        <div style="font-size: 18px; font-weight: 800; color: white; margin-top: 4px;">
                            <?php echo $nbrClient ?> clients </div>
                    </div>
                    <span style="font-size: 24px;">👥</span>
                </div>
            </div>
            ...
            <div
                ...
                <button id="catalog-tab-btn-products" class="nav-item active"
                    style="padding: 10px 20px; font-size: 12px; text-transform: uppercase; font-weight: 700;"
                    onclick="switchCatalogTab('products')">🏷️ Gestion Produits</button>
                <button id="catalog-tab-btn-clients" class="nav-item"
                    style="padding: 10px 20px; font-size: 12px; text-transform: uppercase; font-weight: 700;"
                    onclick="switchCatalogTab('clients')">👥 Gestion Clients</button>
                <button id="catalog-tab-btn-suppliers" class="nav-item"
                    style="padding: 10px 20px; font-size: 12px; text-transform: uppercase; font-weight: 700;"
                    onclick="switchCatalogTab('suppliers')">🤝 Gestion Fournisseurs</button>
            </div>

            <!-- TAB 1: Gestion Produits -->
            <div id="catalog-panel-products"
                style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start;">
                <!-- Left: Form -->
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="/">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="libelle" class="form-control" placeholder="Ex: Carton de savon"
                                >
                        </div>
                        <div class="form-group">
                            <label for="prix_unitaire">Prix de Vente (FCFA)</label>
                            <input type="number" name="prix_vente" class="form-control" placeholder="Ex: 12000"
                                min="0" >
                        </div> 
                        <div class="form-group">
                            <label for="stock_initial">Stock Initial</label>
                            <input type="number" name="stock_initial" class="form-control" placeholder="Ex: 50" min="0"
                                >
                        </div>
                        <button type="submit" name="action" value="produit" class="btn-submit btn-success" style="width: 100%;">Enregistrer le Produit
                            (DML)</button>
                    </form>
                </div>
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    <div
                        ...
                        <!-- <label
                            style="font-size: 13px; font-weight: 700; color: var(--accent); text-transform: uppercase;">Catalogue
                            Courant</label>
                        <input type="text" id="catalog-search" class="search-control"
                            placeholder="Filtrer les produits..." onkeyup="filterProductsTable()"> -->
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($produits as $produit): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $produit->getPrixVente() ?> F
                                    </td>
                                    <td style="font-weight: 700; color: var(--accent);">
                                        <?= $produit->getStockInitial() ?>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
            ...
            <div id="catalog-panel-clients"
                style="display: none; grid-template-columns: 600px 1fr; gap: 32px; align-items: start;">
                <!-- Left: Form -->
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="/">
                        ...
                        <div class="form-group" style="margin-top: 12px;">
                            ...
                            <input type="text" name="numero_telephone" class="form-control" placeholder="Ex: 776543210"
                                >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="limite_credit" class="form-control" value="150000" min="0"
                                >
                        </div>
                        <button type="submit" name="action" value="client" class="btn-submit" style="width: 100%;">Créer le Compte Client
                            (DML)</button>
                    </form>
                </div>
                ...
                <div class="panel-card" style="margin-bottom: 0;">
                    <label
                        style="font-size: 13px; font-weight: 700; color: var(--accent); display: block; margin-bottom: 12px; text-transform: uppercase;">Répertoire
                        Clients</label>
                        ...
                        <tbody>
                            <?php foreach ($clients as $client): ?>
                                <tr>
                                    ...
                                    <td><?= $client->getNumero_telephone() ?></td>
                                    <td style="font-weight: 700; color: var(--accent);"><?= $client->getLimite_credit() ?> F
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
            ...
            <div id="catalog-panel-suppliers"
                style="display: none; grid-template-columns: 600px 1fr; gap: 32px; align-items: start;">
                <!-- Left: Form -->
                <div class="panel-card" style="margin-bottom: 0;">
                    ...
                    <form method="POST" action="/" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nom" class="form-control"
                                placeholder="Ex: Comptoir Céréalier Sénégalais" >
                        </div>
                        <div class="form-group">
                            <label for="telephone">Téléphone</label>
                            <input type="text" name="numero_telephone" class="form-control" placeholder="Ex: 338245678"
                                >
                        </div>
                        <div class="form-group">
                            <label for="adresse">Adresse / Dépôt</label>
                            <input type="text" name="adresse" class="form-control"
                                placeholder="Ex: Hangar 4, Port de Dakar" >
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="action" value="fournisseur" class="btn-submit" style="width: 100%;">Créer le Fournisseur (DML)</button>
                    </form>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($fournisseurs as $fournisseur): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $fournisseur->getNumeroTelephone() ?>
                                    </td>
                                    <td style="font-weight: 700; color: var(--accent);">
                                        <?= $fournisseur->getAdresse() ?> F
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
