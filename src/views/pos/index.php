...
<div id="view-pos" class="view-section">
    ...
    <div style="display: grid; grid-template-columns: 600px 1fr; gap: 32px; align-items: start; margin-bottom: 32px;">
        ...
        <div class="panel-card" style="margin-bottom: 0; padding: 24px; border: 1px solid rgba(59, 130, 246, 0.2); background: linear-gradient(180deg, rgba(17, 24, 43, 0.5) 0%, rgba(10, 15, 30, 0.3) 100%); position: sticky; top: 24px;">
            ...
            <form method="POST" action="http://localhost:8000/lister/vente" alert('Action enregistrée (mode démonstration HTML/CSS)');" id="order-creation-form">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <select name="client_id" id="client-select" class="form-control" style="width: 100%; appearance: none; padding-right: 30px;" onchange="updateClientLimitInfo()">
                            ...
                            <option value="<?= $client->getId()?>" data-limit="300000">
                                <?= $client->getNom() ?> <?= $client->getPrenom() ?> <?= '(' .$client->getNumeroTelephone(). ')' ?>
                            </option>
                            <?php endforeach ?>
                ...
                <div style="border-top: 1px dashed var(--border-color); padding-top: 16px; margin-top: 16px; margin-bottom: 16px;">
                    ...
                    <div style="display: grid; grid-template-columns: 2.2fr 0.8fr auto; gap: 8px; align-items: flex-end; margin-bottom: 16px;">
                        ...
                        <div class="form-group" style="margin-bottom: 0;">
                            ...
                            <select name = "produit_id" id="pos-item-select" class="form-control" style="background-color: #0b0f1a; color: white; padding: 10px; font-size: 12px;">
                                ...
                                <option value="<?= 
                                    ...
                                    $produit->getLibelle()
                                ?>">
                                    <?= $produit->getLibelle(). '(' .$produit->getStockInitial(). ')' ?>
                                </option>
                                <?php endforeach ?>
                        ...
                        <div class="form-group" style="margin-bottom: 0; position: relative;">
                            ...
                            <input type="number" name='quantite' id="pos-qty" class="form-control" style="padding: 10px; font-size: 12px;" onfocus="showKeypad('pos-qty')">
                        </div>

                        <button type="submit" name="btn" value="panier" class="btn-submit" onclick="addToCart(event)" style="height: 38px; width: 38px; font-size: 18px; display: flex; justify-content: center; align-items: center; border-radius: 8px; padding: 0; flex-shrink: 0; min-width: 38px;">
                            +
                        </button>
                    ...
                    <table class="debt-table" style="font-size: 11px; margin-top: 16px;">
                        ...
                        <tbody id="cart-rows">
                            ...
                            <tr id="empty-cart-row">
                                <td colspan="4" style="text-align: center; color: var(--text-muted); padding: 16px 0; border-bottom: none;">
                ...
                <div style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.08) 0%, rgba(30, 41, 59, 0.4) 100%); border: 1px solid rgba(59, 130, 246, 0.15); border-radius: 16px; padding: 14px; text-align: center; margin-bottom: 20px; box-shadow: inset 0 0 15px rgba(59, 130, 246, 0.08);">
                    ...
                    <div style="font-size: 24px; font-weight: 900; color: #60a5fa; letter-spacing: -0.5px; font-family: monospace; text-shadow: 0 0 10px rgba(96, 165, 250, 0.3);">
                        <span id="montant_total_display_text">0</span>
                        <span style="font-size: 14px; font-weight: 700;">FCFA</span>
                    </div>
                ...
                <button type="submit" name="btn" value="valider" class="btn-submit btn-success" style="padding: 14px; font-weight: 800; font-size: 13px; width: 100%;">
            ...
            <table class="debt-table" id="orders-main-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge badge-success">CRÉDIT TOTAL ou AVANCE (Credit) ou COMPTANT (Wave)</span>
                        </td>

                        <td>
                            <button class="btn-quick-action" onclick="toggleDetails('order-details-1')">
                                Lignes
                            </button>
                        </td>
                    </tr>
