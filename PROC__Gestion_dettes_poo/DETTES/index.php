                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select id="client-select" class="form-control">
                                <option value="1">Diouf Fama</option>
                                <option value="2">Ndiaye Abdou</option>
                                <option value="3">Sarr Moussa</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="debt-amount">Montant Initial (FCFA)</label>
                        <input type="text" id="debt-amount" class="form-control" placeholder="Ex: 250000">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select id="debt-select" class="form-control">
                                <option value="1">#D03 - Sarr Moussa (Reste : 1 700 000 F)</option>
                                <option value="2">#D01 - Ndiaye Abdou (Reste : 800 000 F)</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-row">
